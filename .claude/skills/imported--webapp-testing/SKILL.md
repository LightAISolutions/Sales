...
For this repo, pages are deployed at `https://lightaisolutions.github.io/lightaisolutions/`. To test:
...
with sync_playwright() as p:
    ...
    page.goto('https://lightaisolutions.github.io/lightaisolutions/')
