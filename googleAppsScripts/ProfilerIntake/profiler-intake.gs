var VERSION = "v01.01g";
var TITLE = "Profiler Notes Intake";
var GITHUB_OWNER  = "LightAISolutions";
var GITHUB_REPO   = "Sales";
var GITHUB_BRANCH = "main";
var FILE_PATH     = "googleAppsScripts/ProfilerIntake/profiler-intake.gs";
var DEPLOYMENT_ID = "YOUR_DEPLOYMENT_ID";
var EMBED_PAGE_URL = "https://lightaisolutions.github.io/Sales/profiler-intake.html";
...
var ACL_PAGE_NAME  = "profiler-intake";
var PORTAL_ICON    = "📝";
var PORTAL_DESCRIPTION = "Field-note intake for the Profiler dossiers";
...
function submitFieldNote(sessionToken, payload) {
  ...
  if (!text || text.length > 4000) throw new Error('INVALID_INPUT');
  ...
  try {
    ...
    auditLog('data_write', session.email || 'unknown', 'field_note_submitted', { id: note.id, slug: slug });
      ...
      <script>
        ...
        (function() {
          ...
          submitBtn.addEventListener('click', function() {
            ...
            if (!text) { setStatus('Write the note first.', 'err'); noteTa.focus(); return; }
            ...
            google.script.run
              .withSuccessHandler(function(res) {
                ...
                noteTa.value = '';
                setStatus('Saved ' + res.id + ' (' + res.slug + ', confidence ' + res.confidence + '). It appears in the Profiler ⚙ changelog after the next deploy (~1–2 min).', 'ok');
              })
              .withFailureHandler(function(e) {
                submitBtn.disabled = false;
