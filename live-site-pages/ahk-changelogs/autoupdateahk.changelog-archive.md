# Changelog Archive — AutoUpdate (AutoHotkey)

Older version sections rotated from [autoupdateahk.changelog.md](autoupdateahk.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
