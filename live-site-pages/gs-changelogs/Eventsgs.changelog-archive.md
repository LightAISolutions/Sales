# Changelog Archive — Events (Google Apps Script)

Older version sections rotated from [Eventsgs.changelog.md](Eventsgs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
