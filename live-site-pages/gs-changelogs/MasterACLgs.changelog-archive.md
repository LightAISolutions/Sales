# Changelog Archive — MasterACL (Google Apps Script)

Older version sections rotated from [MasterACLgs.changelog.md](MasterACLgs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
