# Changelog Archive — Network (Google Apps Script)

Older version sections rotated from [Networkgs.changelog.md](Networkgs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
