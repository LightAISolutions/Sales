...
### Changed
- The library now groups one more module under an existing topic heading; no other module changed
...
### Added
- Guidance library updated with a new policy module
## [v01.31g] — 2026-09-01 01:51:37 AM EST — v04.02r
...
## [v01.30g] — 2026-08-31 05:18:48 AM EST — v03.99r

### Changed
- Coverage is now served only to contributors and administrators. Other access levels are told so directly rather than receiving an empty result
...
### Added
- Backend support for the new dossier Coverage view (recent industry news about each company)
