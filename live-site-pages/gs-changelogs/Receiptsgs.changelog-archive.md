# Changelog Archive — Receipts (Google Apps Script)

Older version sections rotated from [Receiptsgs.changelog.md](Receiptsgs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
