# Changelog Archive — Profiler Notes Intake (Google Apps Script)

Older version sections rotated from [profiler-intakegs.changelog.md](profiler-intakegs.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
