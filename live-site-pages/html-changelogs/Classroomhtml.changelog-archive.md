# Changelog Archive — Classroom — BESS/AIDC Curriculum

Older version sections rotated from [Classroomhtml.changelog.md](Classroomhtml.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
