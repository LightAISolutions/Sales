# Changelog Archive — MasterACL

Older version sections rotated from [MasterACLhtml.changelog.md](MasterACLhtml.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
