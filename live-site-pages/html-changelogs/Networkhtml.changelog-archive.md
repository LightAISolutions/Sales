# Changelog Archive — Network

Older version sections rotated from [Networkhtml.changelog.md](Networkhtml.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
