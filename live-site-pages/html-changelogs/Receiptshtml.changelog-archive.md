# Changelog Archive — Receipts

Older version sections rotated from [Receiptshtml.changelog.md](Receiptshtml.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
