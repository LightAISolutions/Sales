# Changelog Archive — Profiler Notes Intake

Older version sections rotated from [profiler-intakehtml.changelog.md](profiler-intakehtml.changelog.md). Full granularity preserved — entries are moved here verbatim when the main changelog exceeds 50 version sections.
