...
Nothing in E4 fetches LinkedIn, a listing site or an organiser's attendee list (grep-checked: the served page and the `.gs` carry no such host; the only LinkedIn reference is Network's manual-kind rule).
