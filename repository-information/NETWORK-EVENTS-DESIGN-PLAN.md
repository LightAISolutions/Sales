...
|---|---|---|
| NE0 · design gate | Fable 5.1 xhigh | **Proposed — awaiting the gate session.** This file is the input. **Four rows pre-settled by the developer on 2026-09-19** (D1 amended to "Ecosystem"; D3, D10, D13 approved) and D15 amended to draft-first; the gate walks the remaining eleven |
