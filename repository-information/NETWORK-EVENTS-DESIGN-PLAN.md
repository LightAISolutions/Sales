...
**≈ 23 sessions**: NE0 1 · N0–N4 8 · E0–E5 10–11 · B 1 · X 1 · Q 1; R is outside the count. Twenty-one of them are Fable 5.1 High; two are Fable 5.1 xhigh; two carry an Opus 5 xhigh half.
...
|---|---|---|
| NE0 · design gate | Fable 5.1 xhigh | **Proposed — awaiting the gate session.** This file is the input. **Six rows settled by the developer on 2026-09-19** (D1 "Ecosystem"; D3, D10, D13 approved; D11 approved and widened; D15 decided as in-app drafts) and D17 added; the gate walks the remaining eleven — D2, D4, D5, D6, D7, D8, D9, D12, D14, D16, D17 |
