...
| `notes[].submittedVia` | string | no | `issue-form (#N)` when the note came from the in-dossier quick-note box / GitHub issue form; absent for Claude-command and file-based captures |
