...
The **sanitized, in-app** rendering of a company study guide, generated by the **Profiler Prep Command** (see `.claude/rules/profiler-app.md`). The full private prep materials live in `repository-information/interview-prep/<slug>/` (not deployed); this file is the public-safe subset — it must read as neutral company study material and contain **no** references to interviews, job applications, recruiters, or the developer's personal circumstances.
