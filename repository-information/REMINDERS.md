...
- `2026-09-24 09:54:50 PM EST` — **Check the 9/30 Classroom pipeline run on or after Wednesday 2026-09-30** — the weekly Routine "Classroom curriculum pipeline (C2) - weekly" fires at 4:00 AM PDT. Open its session and read the final `CLASSROOM PIPELINE — 2026-09-30 — …` report.
  ...
  - **Fold in (added 2026-09-25 11:09 PM EST):** the Classroom re-pin of `landscape-utilities-2026-09` and the three `scenario-utilities-*` rehearsals against the eleven utility dossiers — the paste-in prompt is `repository-information/classroom-utilities-repin-prompt.md` (Opus 5.5 xhigh recommended; Part A of it is this run check).
