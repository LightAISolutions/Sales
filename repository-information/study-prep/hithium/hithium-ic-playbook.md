...
3. **Tell the sodium counter-story honestly.** We ship sodium today at utility scale — the ∞Cell N162Ah (≥20,000-cycle class) and the ∞Power N 1h system. But never overclaim the AIDC sodium SKU (its mass production is unconfirmed). The credible line: *"we ship sodium now in one utility SKU; here is the roadmap and what we will commit to in writing."* Overclaiming to this buyer hands the account to Peak.
