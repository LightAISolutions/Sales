...
| "What's a Panama module, really?" | The device class NVIDIA's ecosystem calls a solid-state transformer or MV sidecar: medium voltage in, DC out, one stage — except productized in 2019, factory-built and pre-tested, 2.5MW per block, co-developed with Alibaba |
